...
function root(request, response) {
  var url = request.url;
  response.send("<h1>Hello world!</h1><p>Your root path is ".concat(url, "</p"));
  debugger;
...
/* harmony import */ var _routes_home__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./routes/home */ "./src/routes/home.ts");
/* harmony import */ var _routes_client__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./routes/client */ "./src/routes/client.ts");
...
app.get("/home", _routes_home__WEBPACK_IMPORTED_MODULE_4__.home);
app.get("/client", _routes_client__WEBPACK_IMPORTED_MODULE_5__.client);
